...
GROQ_API_KEY = os.environ.get("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")
if not GROQ_API_KEY:
    logger.warning("GROQ_API_KEY environment variable is not set! Using fallback mock data.")
